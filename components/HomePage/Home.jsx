...
const Home = () => {
    ...
    return (
        <MainLayout>
            ...
            <AdvantagesSection>
                <AdvantagesTitle>
                СОТРУДНИЧАЯ С «ВИНДЭК» НАШИ ЗАКАЗЧИКИ-ПАРТНЕРЫ ПОЛУЧАЮТ:
                </AdvantagesTitle>
                <Container>
                <AdvantagesList>
