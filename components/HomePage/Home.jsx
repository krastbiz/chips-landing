...
const Home = () => {
    ...
    return (
        <MainLayout>
            ...
            <AdvantagesSection>
                <AdvantagesTitle>
                СОТРУДНИЧАЯ С «ИНДРАЙВ» НАШИ ЗАКАЗЧИКИ-ПАРТНЕРЫ ПОЛУЧАЮТ:
                </AdvantagesTitle>
                <Container>
                <AdvantagesList>
