...
const Home = () => {
    ...
    return (
        <MainLayout>
            ...
            <AdvantagesSection>
                <AdvantagesTitle>
                СОТРУДНИЧАЯ С ТАУ ЭЛЕКТРОНИКС НАШИ ЗАКАЗЧИКИ-ПАРТНЕРЫ ПОЛУЧАЮТ:
                </AdvantagesTitle>
                <Container>
                <AdvantagesList>
