...
const Home = () => {
    ...
    return (
        <MainLayout>
            ...
            <AdvantagesSection>
                <AdvantagesTitle>
                СОТРУДНИЧАЯ С ЧИПСЭЛЛ НАШИ ЗАКАЗЧИКИ-ПАРТНЕРЫ ПОЛУЧАЮТ:
                </AdvantagesTitle>
                <Container>
                <AdvantagesList>
