    ...
    return (
        <AboutSectionContainer id="about">
            <AboutContainer>
                ...
                />
                <ValuesItemMobile title="Наши ценности" content={valuesContent} />
            </AboutContainer>
        </AboutSectionContainer>
    )
}

export const AboutSectionBottom = () => {
    return (
        <AboutSectionContainer id="aboutBottom">
            <AboutContainer>
            <AboutSectionItemMobile
...
export const AboutSectionItemMobile = ({ title, content }) => {
    return (
        <ItemContainer>
            <Title>{title}</Title>
            <Text>{content}</Text>
...
export const ValuesItemMobile = ({ title, content }) => {
    return (
        <ItemContainer>
            <Title>{title}</Title>
            <ValueContainer>
