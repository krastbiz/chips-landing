        ...
        <Container>
            <RequestFormWrapper>
                <TitleWrapper>
                    ...
                    <FormSubtitle>
                        Заполняя форму "Запрос компонента", по возможности, просим указать:
                        <br />- Партномер
                        <br />- Корпус
                        <br />- Производителя
                        <br />- Пожелания по году производства
                        <br />- Сроки поставки
                        <br />- Любые другие дополнительные требования к запрашиваемым компонентам
                    </FormSubtitle>
                    <FormSubtitle>
                        Эта информация позволит нам оперативно сформировать для Вас коммерческое предложение, что
                        ускорит процесс обработки Вашего запроса.
                    </FormSubtitle>
                </TitleWrapper>
                <FormWrapper>
                    {emailWasSent ? (
